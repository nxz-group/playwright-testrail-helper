...
export class PerformanceBenchmark {
   ...
   */
  async runBenchmarkSuite(apiClient: TestRailApiClient | BenchmarkApiClient): Promise<BenchmarkSuite> {
  ...
  private async benchmarkApiResponseTime(apiClient: TestRailApiClient | BenchmarkApiClient): Promise<BenchmarkResult> {
  ...
  private async benchmarkBatchOperations(apiClient: TestRailApiClient | BenchmarkApiClient): Promise<BenchmarkResult> {
  ...
  private async benchmarkConcurrentRequests(apiClient: TestRailApiClient | BenchmarkApiClient): Promise<BenchmarkResult> {
  ...
  private async benchmarkMemoryUsage(apiClient: TestRailApiClient | BenchmarkApiClient): Promise<BenchmarkResult> {
  ...
  private async benchmarkLargeDataProcessing(apiClient: TestRailApiClient | BenchmarkApiClient): Promise<BenchmarkResult> {
  ...
  private async benchmarkThroughput(apiClient: TestRailApiClient | BenchmarkApiClient): Promise<BenchmarkResult> {
  ...
  private calculateSummary(results: BenchmarkResult[]) {
    ...
    return {
      ...
      averageDuration: successfulResults.length > 0 
        ...
        : 0,
      totalMemoryUsed: results.reduce((sum, r) => sum + (r.memoryUsage.after - r.memoryUsage.before), 0),
