...
class FailureCapture {
     ...
     */
    static extractFailureInfo(testInfo, testResult, _steps) {
     ...
     */
    static formatFailureComment(failureInfo, _includeStackTrace = false) {
        const parts = [];
     ...
     */
    static extractInterruptionFailure(_testInfo, testResult) {
