...
import { type TestCase, TestRailError, type TestRun, ValidationError } from '../../../src/types';
...
describe('TestRunManager', () => {
  ...
  describe('createTestRun', () => {
    ...
    it('should create test run with section cases', async () => {
      ...
      const _result = await testRunManager.createTestRun({
        name: 'Test Run 1',
        sectionId: 123,
      });
    ...
    it('should validate required fields', async () => {
      await expect(testRunManager.createTestRun({ name: '' })).rejects.toThrow(ValidationError);
  ...
  describe('getTestRun', () => {
    ...
    it('should handle not found error', async () => {
      ...
      await expect(testRunManager.getTestRun(999)).rejects.toThrow('Test run 999 not found');
    });
  });
  ...
  describe('updateTestRun', () => {
    ...
    it('should validate update data', async () => {
      await expect(testRunManager.updateTestRun(1, {})).rejects.toThrow(ValidationError);
    });
  });
